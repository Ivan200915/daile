...
export const MewingTools = () => {
    ...
    return (
        <div className="flex-1 flex flex-col p-6 pt-20 overflow-y-auto no-scrollbar pb-24">
            <h2 className="text-3xl font-bold mb-6 text-center">Jawline Tools</h2>
            ...
            {/* Daily Tips */}
            <h3 className="text-lg font-bold mb-3">Daily Tips</h3>
            <div className="space-y-3">
                <div className="bg-white/5 border border-white/10 p-4 rounded-xl flex items-start space-x-3">
                    ...
                    <div>
                        <h4 className="font-bold text-sm">Tongue Posture</h4>
                        <p className="text-xs text-white/60">Press your entire tongue against the roof of your mouth, specifically the posterior third.</p>
                    </div>
                </div>
                <div className="bg-white/5 border border-white/10 p-4 rounded-xl flex items-start space-x-3">
                    <div className="p-2 bg-[#00D4AA]/20 rounded-lg text-[#00D4AA]">
                    ...
                    <div>
                        <h4 className="font-bold text-sm">Teeth Position</h4>
                        <p className="text-xs text-white/60">Keep your teeth lightly touching or slightly apart. Do not clench.</p>
                    </div>
                </div>
            </div>
                ...
                <div className="fixed inset-0 bg-black/80 backdrop-blur-md z-50 flex items-center justify-center p-6 animate-fade-in" onClick={() => setShowGuide(false)}>
                    <div className={`${GLASS_PANEL} p-6 w-full max-w-sm bg-[#1A1A1A]`} onClick={e => e.stopPropagation()}>
                        <div className="flex justify-between items-center mb-4">
                            <h3 className="text-xl font-bold">What is Mewing?</h3>
                            <button onClick={() => setShowGuide(false)}><Icons.X size={24} className="text-white/50" /></button>
                        </div>
                        <p className="text-white/70 text-sm mb-4 leading-relaxed">
                            Mewing is a technique of proper tongue posture that can define your jawline over time.
                            The goal is to rest your tongue on the roof of your mouth rather than the bottom.
                        </p>
                        <h4 className="font-bold text-[#00D4AA] mb-2">How to do it:</h4>
                        <ol className="list-decimal list-inside text-sm text-white/70 space-y-2 mb-6">
                            <li>Close your lips.</li>
                            <li>Move your jaw so your front bottom teeth are just behind your front upper teeth.</li>
                            <li>Cover the roof of your mouth with your tongue.</li>
                            <li>Place the tip of your tongue right behind your front teeth without touching them.</li>
                        </ol>
                        <button onClick={() => setShowGuide(false)} className={`w-full py-3 ${ACCENT_BUTTON}`}>Got it</button>
                    </div>
                </div>
            )}
        </div>
